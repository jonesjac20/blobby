...
Production Compose and PR-preview Fargate start the same client as a sidecar (`--count 24`) so those lobbies are populated without running this by hand. Local servers still need the command above.
