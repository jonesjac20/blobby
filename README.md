...
**Play:** [http://34.195.201.37:8000](http://34.195.201.37:8000) (name, color, Play / Spectate). Production and PR previews already run 24 bots as a sidecar. Extra local bots: `python -m bots.simple_bot --url http://34.195.201.37:8000/ws --count 5`.
...
python -m bots.simple_bot --count 24   # living-lobby stress; tick Hz is logged by the server
...
- `infra/preview/` — Phase 14 Fargate PR previews (foundation applied once; per-PR service in the prod VPC). Human steps are in `docs/phase8-annex.md`.
